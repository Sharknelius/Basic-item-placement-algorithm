...
# Rewrite to be brute-force algorithm that tries all possible placements of items in reachable nodes until it finds a finishable configuration or exhausts possibilities.
